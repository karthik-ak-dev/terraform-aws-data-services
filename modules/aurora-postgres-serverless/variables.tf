# ============================================================================
# VARIABLES FOR AURORA POSTGRESQL SERVERLESS V2 MODULE
# ============================================================================
...
variable "instance_count" {
  description = "Number of serverless instances"
  type        = number
  default     = 1
}
...
variable "min_capacity" {
  description = "Minimum Aurora Capacity Units (ACUs). Range: 0.5-128"
  type        = number
  default     = 0.5
}

variable "max_capacity" {
  description = "Maximum Aurora Capacity Units (ACUs). Range: 0.5-128"
  type        = number
  default     = 4
}
